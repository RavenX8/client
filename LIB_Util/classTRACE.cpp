...
//   ::OutputDebugString( lpszBuffer );
	g_LOG.CS_OUT( 0xffff, lpszBuffer );
}
...
BOOL Trace_INIT( PCSTR lpszInitialSymbolPath )
{
...
void Trace_SOURCE( LPCTSTR lpszMessage, LPCTSTR lpszFileName, ULONG nLineNumber )
{
...
void Trace_STACK( HANDLE hThread, LPCTSTR lpszMessage )
{
