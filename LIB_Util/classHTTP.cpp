...
bool classHTTP::Open() {
  // 인터넷 연결.
  m_hInternet = ::InternetOpen( "httpFILE", INTERNET_OPEN_TYPE_PRECONFIG, nullptr, nullptr, 0 );
...
bool classHTTP::OpenURL(char* szFileURL) {
  ...
  // URL을 연다.
  m_hURL = ::InternetOpenUrl( m_hInternet, szFileURL, nullptr, 0, INTERNET_FLAG_RELOAD, 0 );
  if ( m_hURL ) {
