...
typedef enum _ZZ_RENDERWHERE {
  ZZ_RW_NONE = 0,
  // not in begin_scene() end_scene()
  ZZ_RW_SCENE = 1,
  // normal begin_scene() end_scene()
  ZZ_RW_SHADOWMAP = 2,
  // in shadow rendering
  ZZ_RW_GLOW = 3,
  // render glow
...
struct zz_renderer_cached_info {
  ...
  void invalidate(e_type type = ALL) {
    ...
    switch ( type ) {
      case TEXTURE0: texture[0] = false;
        break;
      case TEXTURE1: texture[1] = false;
        break;
      case TEXTURE2: texture[2] = false;
        break;
      case TEXTURE3: texture[3] = false;
        break;
      case TEXTURE4: texture[4] = false;
        break;
      case TEXTURE5: texture[5] = false;
        break;
      case TEXTURE6: texture[6] = false;
        break;
      case TEXTURE7: texture[7] = false;
        break;
      case VERTEX_SHADER: vertex_shader = false;
        break;
      case PIXEL_SHADER: pixel_shader = false;
        break;
      case VERTEX_BUFFER: vertex_buffer = false;
        break;
      case INDEX_BUFFER: index_buffer = false;
        break;
      case LIGHT: light = false;
        break;
    }
  }
};
