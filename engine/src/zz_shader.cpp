...
zz_shader* zz_shader::shadow_shader       = nullptr;
zz_shader* zz_shader::shadow_shader_skin  = nullptr;
zz_shader* zz_shader::glow_shader         = nullptr;
zz_shader* zz_shader::glow_shader_skin    = nullptr;
zz_shader* zz_shader::terrain_shader      = nullptr;
zz_shader* zz_shader::ssao_shader         = nullptr;
zz_shader* zz_shader::ssao_shader_skin    = nullptr;
zz_shader* zz_shader::post_process_shader = nullptr;
...
zz_shader::zz_shader(void) :
  ...
  for ( int i          = 0; i < ZZ_MAX_SHADER_FORMAT; ++i ) {
    ...
    vshader_names[i]   = nullptr;
    pshader_names[i]   = nullptr;
  }
}
