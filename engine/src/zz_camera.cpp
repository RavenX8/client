...
zz_camera::zz_camera(void) :
  pos_cur_( vec2_null ),
  pos_last_( vec2_null ),
  original_modelview_( mat4_id ),
  our_modelview_( mat4_id ),
  eye_channel_( nullptr ),
  center_channel_( nullptr ),
  up_channel_( nullptr ),
  fovy_near_far_channel_( nullptr ), perspective_( true ),
  fovy_( 0 ),
  aspect_ratio_( 0 ),
  near_plane_( 0 ),
  far_plane_( 0 ), eye_( vec3_null ),
  center_( vec3_null ), up_( vec3_null ),
...
void   zz_camera::pan(vec2 pan_value) {
  ...
  this->get_transform( ZZ_MATRIX_MODELVIEW, origin_mat );
  mat4 pan_tm = mat4_id;
  pan_tm.set_translation( vec3( pan_value.x, pan_value.y, 0 ) );

  set_transform( ZZ_MATRIX_MODELVIEW, origin_mat * pan_tm );
...
void  zz_camera::trackball_begin(float x, float y) {
  ...
  get_transform( ZZ_MATRIX_MODELVIEW, original_modelview_ );
}
...
void zz_camera::calculate_3rd_order_interpolation_func(float time_interval) {
  ...
  mat._11 = 1;
  mat._12 = t_start;
  mat._13 = t_start * t_start;
  mat._14 = t_start * t_start * t_start;
  mat._21 = 0.0f;
  mat._22 = 1;
  mat._23 = 2 * t_start;
  mat._24 = 3 * t_start * t_start;
  mat._31 = 1;
  mat._32 = t_end;
  mat._33 = t_end * t_end;
  mat._34 = t_end * t_end * t_end;
  mat._41 = 0.0f;
  mat._42 = 1;
  mat._43 = 2 * t_end;
  mat._44 = 3 * t_end * t_end;
