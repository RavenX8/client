...
int CManufacture::GetEstimateProbability(int iItemDif, int iItemQuality, int iMatQuality, int iNumMat, short nWorldProd) {
  ...
  switch ( iNumMat ) {
    case 1: fEstimateProbability = fSucProb1;
      break;
    case 2: fEstimateProbability = fSucProb1 * fSucProb2;
      break;
    case 3: fEstimateProbability = fSucProb1 * fSucProb2 * fSucProb3;
      break;
    case 4: fEstimateProbability = fSucProb1 * fSucProb2 * fSucProb3 * fSucProb4;
      break;
    default: fEstimateProbability = 0;
      break;
  }
...
int   CManufacture::GetSuccessPoint(int iSlot, int iItemDif, int iItemQuality, int iNumMat) {
  int iSuccessPoint = 0;
  switch ( iSlot ) {
    case 1: iSuccessPoint = ((iItemDif + 35) * (iItemQuality + 15)) / 16;
      break;
    case 2: iSuccessPoint = ((iItemDif + 15) * (iItemQuality + 140)) / (iNumMat + 3) / 4;
      break;
    case 3: iSuccessPoint = ((iItemDif + 90) * (iItemQuality + 30)) / (iNumMat + 3) / 4;
      break;
    case 4: iSuccessPoint = ((iItemDif + 40) * (iItemQuality + 60)) / (iNumMat + 2) / 6;
      break;
    default: break;
  }
...
bool CManufacture::LoadMakableClasses(int iSkillNo, int iSkillLv) {
  ...
  switch ( iMakeNo ) {
    case SWORD_TYPE: LoadClassesFromSTB( ITEM_TYPE_WEAPON, iMakeNo, iSkillLv );
      break;
    case BLUNT_TYPE: LoadClassesFromSTB( ITEM_TYPE_WEAPON, iMakeNo, iSkillLv );
      break;
    case BOW_TYPE: LoadClassesFromSTB( ITEM_TYPE_WEAPON, iMakeNo, iSkillLv );
      LoadClassesFromSTB( ITEM_TYPE_KNAPSACK, iMakeNo, iSkillLv );
      break;
    case PISTOL_TYPE: LoadClassesFromSTB( ITEM_TYPE_WEAPON, iMakeNo, iSkillLv );
      LoadClassesFromSTB( ITEM_TYPE_KNAPSACK, iMakeNo, iSkillLv );
      break;
    case MAGICWEAPON_TYPE: LoadClassesFromSTB( ITEM_TYPE_WEAPON, iMakeNo, iSkillLv );
      LoadClassesFromSTB( ITEM_TYPE_SUBWPN, iMakeNo, iSkillLv );
      break;
    case SUBEQUIP_TYPE: LoadClassesFromSTB( ITEM_TYPE_SUBWPN, iMakeNo, iSkillLv );
      LoadClassesFromSTB( ITEM_TYPE_KNAPSACK, iMakeNo, iSkillLv );
      break;
    case BATTLEARMOR_TYPE:
    case MAGICARMOR_TYPE:
    case NORMALARMOR_TYPE: LoadClassesFromSTB( ITEM_TYPE_HELMET, iMakeNo, iSkillLv );
      ...
      break;
    case CART_TYPE:
    case CASTLEGEAR_TYPE: LoadClassesFromSTB( ITEM_TYPE_RIDE_PART, iMakeNo, iSkillLv );
      break;
    case ALCHEMY_TYPE: LoadClassesFromSTB( ITEM_TYPE_NATURAL, iMakeNo, iSkillLv );
      break;
    case ACCESSORY_TYPE: LoadClassesFromSTB( ITEM_TYPE_JEWEL, iMakeNo, iSkillLv );
      break;
    case ART_TYPE: LoadClassesFromSTB( ITEM_TYPE_JEWEL, iMakeNo, iSkillLv );
      break;
    case INDUSTRY_TYPE: LoadClassesFromSTB( ITEM_TYPE_NATURAL, iMakeNo, iSkillLv );
      break;
    case GEM_TYPE:
...
bool CManufacture::LoadMakableItem(int iClass, int iSkillNo, int iSkillLv) {
  ...
  m_MakableItems.clear();
  switch ( iMakeNo ) {
    case SWORD_TYPE: LoadItemsFromSTB( ITEM_TYPE_WEAPON, iClass, iMakeNo, iSkillLv );
      break;
    case BLUNT_TYPE: LoadItemsFromSTB( ITEM_TYPE_WEAPON, iClass, iMakeNo, iSkillLv );
      break;
    case BOW_TYPE: LoadItemsFromSTB( ITEM_TYPE_WEAPON, iClass, iMakeNo, iSkillLv );
      LoadItemsFromSTB( ITEM_TYPE_KNAPSACK, iClass, iMakeNo, iSkillLv );
      break;
    case PISTOL_TYPE: LoadItemsFromSTB( ITEM_TYPE_WEAPON, iClass, iMakeNo, iSkillLv );
      LoadItemsFromSTB( ITEM_TYPE_KNAPSACK, iClass, iMakeNo, iSkillLv );
      break;
    case MAGICWEAPON_TYPE: LoadItemsFromSTB( ITEM_TYPE_WEAPON, iClass, iMakeNo, iSkillLv );
      LoadItemsFromSTB( ITEM_TYPE_SUBWPN, iClass, iMakeNo, iSkillLv );
      break;
    case SUBEQUIP_TYPE: LoadItemsFromSTB( ITEM_TYPE_SUBWPN, iClass, iMakeNo, iSkillLv );
      LoadItemsFromSTB( ITEM_TYPE_KNAPSACK, iClass, iMakeNo, iSkillLv );
      break;
    case BATTLEARMOR_TYPE:
    case MAGICARMOR_TYPE:
    case NORMALARMOR_TYPE: LoadItemsFromSTB( ITEM_TYPE_HELMET, iClass, iMakeNo, iSkillLv );
      ...
      break;
    case CART_TYPE:
    case CASTLEGEAR_TYPE: LoadItemsFromSTB( ITEM_TYPE_RIDE_PART, iClass, iMakeNo, iSkillLv );
      break;

    case ALCHEMY_TYPE: LoadItemsFromSTB( ITEM_TYPE_NATURAL, iClass, iMakeNo, iSkillLv );
      break;
    case ACCESSORY_TYPE: LoadItemsFromSTB( ITEM_TYPE_JEWEL, iClass, iMakeNo, iSkillLv );
      break;
    case ART_TYPE: LoadItemsFromSTB( ITEM_TYPE_JEWEL, iClass, iMakeNo, iSkillLv );
      break;
    case INDUSTRY_TYPE: LoadItemsFromSTB( ITEM_TYPE_NATURAL, iClass, iMakeNo, iSkillLv );
      break;
    case GEM_TYPE: LoadGemItemsFromSTB( ITEM_TYPE_GEM, iClass, iMakeNo, iSkillLv );
      break;
    default:
      assert( 0 && "Invalid Make Type" );
      return false;
