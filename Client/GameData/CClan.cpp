...
void CClan::SetAlly(int iIndex, int iClanID, const char* pszName) {
  ...
  switch ( iIndex ) {
    case 0: m_iAlly1 = iClanID;
      m_strAlly1     = pszName;
      break;
    case 1: m_iAlly2 = iClanID;
      m_strAlly2     = pszName;
      break;
    case 2: m_iAlly3 = iClanID;
      m_strAlly3     = pszName;
      break;
    default:
...
int CClan::GetAllyID(int iIndex) {
  switch ( iIndex ) {
    case 0: return m_iAlly1;
    case 1: return m_iAlly2;
    case 2: return m_iAlly3;
    default:
      assert( 0 && "Invald Allied Clan Index" );
      break;
  }
...
const char* CClan::GetAllyName(int iIndex) {
  switch ( iIndex ) {
    case 0: return m_strAlly1.c_str();
    case 1: return m_strAlly2.c_str();
    case 2: return m_strAlly3.c_str();
    default:
      assert( 0 && "Invald Allied Clan Index" );
      break;
  }
...
void CClan::RequestMemberList() {
  g_pNet->Send_cli_CLAN_COMMAND( GCMD_ROSTER, nullptr );
}
...
int CClan::GetMaxClassCount(int iClanLevel, int iClass) {
  ...
  switch ( iClass ) {
    case CLAN_SUB_MASTER: return (int)(iClanLevel * 0.3 + 1);
    case CLAN_COMMANDER: return iClanLevel + 2;
    case CLAN_LANDER: return (int)(iClanLevel * 1.8 + 2);
    default: break;
  }
  return 0;
}
...
void              CClan::SetSkill(tagClanSKILL* skilldata, int count) {
  CClanSkillSlot* clan_skill_slot = GetInstance().GetClanSkillSlot();
