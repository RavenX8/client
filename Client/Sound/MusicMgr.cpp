...
bool CMusicMgr::Init(PLAYER_TYPE playerType) {
  ...
  switch ( playerType ) {
    case DIRECT_MUSIC_TYPE: m_pPlayer = new CDirectMusicPlayer();
      break;
    case OGG_MUSIC_TYPE: m_pPlayer = new COggMusicPlayer();
      break;
    case MSS_MUSIC_TYPE: m_pPlayer = new CMSSMusicPlayer();
      break;
  }
