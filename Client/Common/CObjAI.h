...
enum {
  ...
  COMMON_COMMAND_PARTY = 9,
  ///파티결성, 파티조인신청
  COMMON_COMMAND_EXCHANGE = 10,
  ///거래신청
  COMMON_COMMAND_PRIVATESTORE = 11,
  COMMON_COMMAND_SELFTARGET = 12,
  COMMON_COMMAND_BOARD_CART = 13,
  // 카트 탑승 스킬.
};
...
protected :
  ...
  virtual bool IsInRANGE(CObjCHAR* pT, int iRange) =0 { *(int*)nullptr                                                                                        = 10; };
  virtual void ActionEVENT(int     iActionIDX) =0 { *(int*)nullptr                                                                                            = 10; };
  virtual void Adjust_HEIGHT() = 0 { *(int*)nullptr                                                                                                           = 10; };
  virtual int  GetCurrentFrame() = 0 { *(int*)nullptr                                                                                                         = 10; };
  virtual void Set_MOTION(short nActionIdx, float fMoveSpeed = 0, float fAniSpeed = 1.0f, bool bAttackMotion = false, int iRepeatCnt = 0) =0 { *(int*)nullptr = 10; };
  virtual void Move_COMPLETED() =0 { *(int*)nullptr                                                                                                           = 10; };

  virtual int GetANI_Stop() =0 { *(int*)nullptr          = 10; };
  virtual int GetANI_Die() =0 { *(int*)nullptr           = 10; };
  virtual int GetANI_Hit() =0 { *(int*)nullptr           = 10; };
  virtual int GetANI_Move() =0 { *(int*)nullptr          = 10; };
  virtual int GetANI_Attack() =0 { *(int*)nullptr        = 10; };
  virtual int GetANI_Casting() =0 { *(int*)nullptr       = 10; };
  virtual int GetANI_CastingRepeat() =0 { *(int*)nullptr = 10; };
  virtual int GetANI_Skill() =0 { *(int*)nullptr         = 10; };
  ...
  virtual int  Def_AttackRange() =0 { *(int*)nullptr                = 10; };
  virtual int  Get_R_WEAPON() =0 { *(int*)nullptr                   = 10; };
  virtual bool Attack_START(CObjCHAR*  pTarget) =0 { *(int*)nullptr = 10; };
  virtual bool Skill_START(CObjCHAR*   pTarget) =0 { *(int*)nullptr = 10; };
  virtual bool Casting_START(CObjCHAR* pTarget) =0 { *(int*)nullptr = 10; };
  virtual void Casting_END() =0 { *(int*)nullptr                    = 10; };
  virtual void MoveStart() =0 { *(int*)nullptr                      = 10; };
...
#ifndef	__SERVER
  virtual void Attack_END(bool bStopTrail = true) = 0 { *(int*)nullptr     = 10; };
  virtual int  Get_L_WEAPON() =0 { *(int*)nullptr                          = 10; };
  virtual void SetMotionRepeatCount(int iRepeatCount) = 0 { *(int*)nullptr = 10; };

  /// 실제 스킬동작을 할수 있는가?( 서버로 부터 실제 결과를 받았는가? )
  virtual bool bCanActionActiveSkill() = 0 { *(int*)nullptr            = 10; };
  virtual void SetEffectedSkillFlag(bool bResult) = 0 { *(int*)nullptr = 10; };
  virtual bool bCanStartSkill() = 0 { *(int*)nullptr                   = 10; }; /// 서버로 부터 캐스팅 스타트 패킷을 받았는가?
  virtual void SetStartSkill(bool bResult) = 0 { *(int*)nullptr        = 10; };

  virtual void  Set_ModelDIR(t_POSITION& PosToView, bool    bImmediate = false) =0 { *(int*)nullptr  = 10; };
  virtual void  Set_ModelDIR(float       fAngleDegree, bool bImmediate = false) = 0 { *(int*)nullptr = 10; };
  virtual void  Set_ModelSPEED(float     fSpeed) =0 { *(int*)nullptr                                 = 10; };
  virtual float Get_ModelSPEED() = 0 { *(int*)nullptr                                                = 10; };
#endif
  ...
  virtual void RecoverHP(short nRecoverMODE) {
    /* nop */
  }

  virtual void RecoverMP(short nRecoverMODE) {
    /* nop */
  }
...
public:
  ...
  virtual void  Adj_MoveSPEED(WORD wSrvDIST, const D3DVECTOR& PosGOTO) =0 { *(int*)nullptr = 10; };
  virtual void  Adj_AniSPEED(float fAniSpeed) =0 { *(int*)nullptr                          = 10; };;
  virtual float Get_DefaultSPEED() =0 { *(int*)nullptr                                     = 10; };

  virtual void Reset_Position() = 0 { *(int*)nullptr = 10; }; /// 이동 시작시, 현재 위치를 재조정
#endif

protected:
  virtual short GetPsv_ATKSPEED(float fCurSpeed, short nRightWeaponItemNo) { return 0; }
  virtual short GetPsv_ATKSPEED() { return 0; }
  virtual float Get_fAttackSPEED() =0 { *(int*)nullptr = 10; }; /// 기본속도 1.0을 기준 :: 기본 공격 속도( m_fAtkAniSPEED ) + 스킬에 의해 보정된 값 ...
  virtual float Get_MoveSPEED() =0 { *(int*)nullptr    = 10; };
  virtual int   Get_AttackRange() = 0 { *(int*)nullptr = 10; };
  virtual float Get_SCALE() = 0 { *(int*)nullptr       = 10; };

public:
  int         Get_HP() override = 0 { *(int*)nullptr = 10; };
  virtual int Get_MP() = 0 { *(int*)nullptr          = 10; };
  virtual int Get_MaxHP() = 0 { *(int*)nullptr       = 10; };
  virtual int Get_MaxMP() = 0 { *(int*)nullptr       = 10; };

protected:
  virtual DWORD GetIngDurationStateFLAG() = 0 { *(int*)nullptr                 = 10; }; /// 현재 지속 상태 플레그값을 얻는다.
  virtual short GetIngDurationStateSKILL(eING_TYPE eTYPE) = 0 { *(int*)nullptr = 10; }; /// 현재 지속 상태에 적용된 스킬번호
...
public :
  ...
  bool SetCMD_STOP() override;
  bool SetCMD_MOVE2D(float          fPosX, float fPosY, BYTE btRunMODE) override;
  bool SetCMD_MOVE(const D3DVECTOR& vPosTo, BYTE btRunMODE) override;
  ...
  void SetCMD_RUNnATTACK(int iTargetObjTAG) override {
  ...
  int          Get_WorldTIME(void    ) override;
  ...
  char Do_SKILL(int           iServerTarget, CObjCHAR* pTarget = nullptr);
...
public :
  ...
  /// 현재 명령을 적용할수 있는가?
  virtual bool CanApplyCommand() = 0 { *(int*)nullptr = 10; };

  virtual void PushCommandSit() = 0 { *(int*)nullptr                                                                                            = 10; };
  virtual void PushCommandStand() = 0 { *(int*)nullptr                                                                                          = 10; };
  virtual void PushCommandStop() = 0 { *(int*)nullptr                                                                                           = 10; };
  virtual void PushCommandMove(const D3DVECTOR& PosTo, BYTE                btRunMODE) = 0 { *(int*)nullptr                                      = 10; };
  virtual void PushCommandMove(WORD             wSrvDIST, const D3DVECTOR& PosTO, int                 iServerTarget) = 0 { *(int*)nullptr       = 10; };
  virtual void PushCommandAttack(int            iServerTarget, WORD        wSrvDIST, const D3DVECTOR& PosTO) = 0 { *(int*)nullptr               = 10; };
  virtual void PushCommandDie() = 0 { *(int*)nullptr                                                                                            = 10; };
  virtual void PushCommandToggle(BYTE                btTYPE) = 0 { *(int*)nullptr                                                               = 10; };
  virtual void PushCommandSkill2Self(short           nSkillIDX) = 0 { *(int*)nullptr                                                            = 10; };
  virtual void PushCommandSkill2Obj(WORD             wSrvDIST, const D3DVECTOR& PosTO, int iServerTarget, short nSkillIDX) = 0 { *(int*)nullptr = 10; };
  virtual void PushCommandSkill2Pos(const D3DVECTOR& PosGOTO, short             nSkillIDX) = 0 { *(int*)nullptr                                 = 10; };
