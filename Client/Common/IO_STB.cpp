...
#define	MAX_TEMP_STR	2048
    ...
    for ( nY              = 0; nY < this->m_nDataCnt; nY++ ) {
      ...
      if ( iKeyColIDX >= 0 ) {
        ...
        iRetCnt = WideCharToMultiByte( CP_ACP, 0, pWStr, -1, pStr, MAX_TEMP_STR, nullptr, nullptr );
        if ( *pStr && iRetCnt ) {
