...
bool CITStateNormal::ProcessHotKeyNormalInput(unsigned uiMsg, WPARAM wParam, LPARAM lParam) {
  if ( CTEditBox::s_pFocusEdit == nullptr ) ///입력 포커스가 없는경우
  {
    switch ( uiMsg ) {
      case WM_KEYDOWN: {
        ...
        switch ( vk ) {
          case 0x41: g_itMGR.OpenDialog( DLG_TYPE_CHAR );
            return true;
          case 0x43: g_itMGR.OpenDialog( DLG_TYPE_COMMUNITY );
            return true;
          case 0x48: g_itMGR.OpenDialog( DLG_TYPE_HELP );
            return true;
          case 0x49:
          case 0x56: g_itMGR.OpenDialog( DLG_TYPE_ITEM );
            return true;
          case 0x53: g_itMGR.OpenDialog( DLG_TYPE_SKILL );
            return true;
          case 0x51: g_itMGR.OpenDialog( DLG_TYPE_QUEST );
            return true;
          case 0x4d: {
          ...
          case 0x4e: {
            ...
            /*	case 0x58:
                ...
                return true;*/
          case 0x4f: g_itMGR.OpenDialog( DLG_TYPE_OPTION );
            return true;
          default: break;
        }
      }
