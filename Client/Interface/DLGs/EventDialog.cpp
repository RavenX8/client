...
void CEventDialog::SetScript(char* pszScript) {
  ...
  if ( CCountry::GetSingleton().IsApplyNewVersion() ) {
    ...
    iLineHeight = 12;
    pItem       = new CDialogNpcScriptItem( 0, nullptr, iImageID, iLineHeight, iWidth, 0 );
    pListBox->Add( pItem );
    iListBoxHeight += pItem->GetHeight();
    ...
    iLineHeight = 12;
    pAnswerItem = new CDialogNpcScriptAnswerItem( 0, nullptr, 0, nullptr, iImageID, iLineHeight, iWidth );
    pListBox->Add( pAnswerItem );
    iAnswerListBoxHeight += pAnswerItem->GetHeight();
