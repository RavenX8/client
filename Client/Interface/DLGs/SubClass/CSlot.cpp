...
unsigned int CSlot::Process(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
  ...
  switch ( uiMsg ) {
    case WM_LBUTTONUP: m_bClicked = false;
      break;
    case WM_LBUTTONDOWN: {
...
///*------------------------------------------------------------------------------------------
//*----------------------------------------------------------------------------
CSlotBuyPrivateStore* CSlotBuyPrivateStore::s_pSelectedSlot = nullptr;
