...
void CChatRoomDlg::OnLButtonDown(unsigned uiProcID, WPARAM wParam, LPARAM lParam) {
  switch ( uiProcID ) {
    case IID_TABBUTTON_MEMBER: m_iTab = TAB_MEMBER;
      break;
    case IID_TABBUTTON_CONFIG: m_iTab = TAB_CONFIG;
      break;
    default: break;
  }
}
...
void CChatRoomDlg::Update(CObservable* pObservable, CTObject* pObj) {
  ...
  switch ( pEvent->GetID() ) {
    ...
    case CTEventChatRoom::EID_STATE_DEACTIVATED: break;
