...
unsigned int CNumberInputDlg::Process(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
  ...
  if ( iProcID     = CTDialog::Process( uiMsg, wParam, lParam ) ) {
    switch ( uiMsg ) {
      case WM_LBUTTONDOWN: SetFocusEditBox();
        break;
...
void CNumberInputDlg::OnLButtonUp(unsigned iProcID) {
  switch ( iProcID ) {
    case IID_BTN_0: AppendText( "0" );
      break;
    case IID_BTN_1: AppendText( "1" );
      break;
    case IID_BTN_2: AppendText( "2" );
      break;
    case IID_BTN_3: AppendText( "3" );
      break;
    case IID_BTN_4: AppendText( "4" );
      break;
    case IID_BTN_5: AppendText( "5" );
      break;
    case IID_BTN_6: AppendText( "6" );
      break;
    case IID_BTN_7: AppendText( "7" );
      break;
    case IID_BTN_8: AppendText( "8" );
      break;
    case IID_BTN_9: AppendText( "9" );
      break;

    case IID_BUTTON_CLOSE: m_iLastInputNumber = 0;
      ClearCommand();
      Hide();
      break;
    case IID_BTN_DEL: DeleteOneChar();
      break;
    case IID_BTN_OK: m_iLastInputNumber = GetNumberFromEditBox();
      SendCommand();
      Hide();
      break;
    case IID_BTN_MAX: if ( m_iMaxNumber >= 0 ) {
