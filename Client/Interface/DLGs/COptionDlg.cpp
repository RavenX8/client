...
void COptionDlg::OnLButtonUp(unsigned iProcID) {
  switch ( iProcID ) {
    case IID_BTN_ICONIZE: g_itMGR.AddDialogIcon( GetDialogType() );
      break;
    case IID_BTN_INITIALIZE: g_itMGR.InitInterfacePos();
      InitOption();
      break;
    case IID_TABBUTTON_VIDEO: m_iTab = IID_TABVIDEO;
      break;
    case IID_TABBUTTON_AUDIO: m_iTab = IID_TABAUDIO;
      break;
    case IID_TABBUTTON_PLAY: m_iTab = IID_TABPLAY;
      break;
    case IID_TABBUTTON_COMMUNITY: m_iTab = IID_TABCOMMUNITY;
      break;
    case IID_TABBUTTON_KEYBOARD: m_iTab = IID_TABKEYBOARD;
      break;
    case IID_BTN_CONFIRM: ChangeOption();
      SaveCurrentOption();
      Hide();
      break;
      //case IID_BTN_CANCEL:
...
unsigned int COptionDlg::Process(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
  ...
  if ( iProcID     = CTDialog::Process( uiMsg, wParam, lParam ) ) {
    switch ( uiMsg ) {
      case WM_LBUTTONDOWN: OnLButtonDown( iProcID );
        break;
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      ...
      switch ( uiPressedBtn ) {
        ...
        case IID_RADIOBTN_NORMALCHATTING: {
          ...
          if ( CTEditBox::s_pFocusEdit == nullptr && pDlg != nullptr )
            pDlg->Show();
...
void COptionDlg::ChangeOption() {
  ...
  switch ( m_iTab ) {
    case IID_TABVIDEO: ChangeVideoOption();
      break;
    case IID_TABAUDIO: ChangeAudioOption();
      break;
    case IID_TABPLAY: ChangePlayOption();
      break;
    case IID_TABCOMMUNITY: ChangeCommunityOption();
      break;
    case IID_TABKEYBOARD: ChangeKeyboardOption();
      break;
    default: break;
  }
}
...
void        COptionDlg::ChangeCommunityOption() {
  ...
  if ( pCtrl && pCtrl->GetControlType() == CTRL_TABBEDPANE ) {
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      CTRadioBox* pRadioBox = (CTRadioBox*)pCtrl;
      switch ( pRadioBox->GetPressedButtonID() ) {
        case IID_RADIOBTN_WHISPER_ON: m_CommunityOption.iWhisper = 1;
          break;
        case IID_RADIOBTN_WHISPER_OFF: m_CommunityOption.iWhisper = 0;
          break;
        default: break;
      }
    }
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      CTRadioBox* pRadioBox = (CTRadioBox*)pCtrl;
      switch ( pRadioBox->GetPressedButtonID() ) {
        case IID_RADIOBTN_ADDFRIEND_ON: m_CommunityOption.iAddFriend = 1;
          break;
        case IID_RADIOBTN_ADDFRIEND_OFF: m_CommunityOption.iAddFriend = 0;
          break;
        default: break;
      }
    }
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      CTRadioBox* pRadioBox = (CTRadioBox*)pCtrl;
      switch ( pRadioBox->GetPressedButtonID() ) {
        case IID_RADIOBTN_EXCHANGE_ON: m_CommunityOption.iExchange = 1;
          break;
        case IID_RADIOBTN_EXCHANGE_OFF: m_CommunityOption.iExchange = 0;
          break;
        default: break;
      }
    }
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      CTRadioBox* pRadioBox = (CTRadioBox*)pCtrl;
      switch ( pRadioBox->GetPressedButtonID() ) {
        case IID_RADIOBTN_PARTY_ON: m_CommunityOption.iParty = 1;
          break;
        case IID_RADIOBTN_PARTY_OFF: m_CommunityOption.iParty = 0;
          break;
        default: break;
      }
    }
    ...
    if ( pCtrl && pCtrl->GetControlType() == CTRL_RADIOBOX ) {
      CTRadioBox* pRadioBox = (CTRadioBox*)pCtrl;
      switch ( pRadioBox->GetPressedButtonID() ) {
        case IID_RADIOBTN_MESSANGER_ON: m_CommunityOption.iMessanger = 1;
          break;
        case IID_RADIOBTN_MESSANGER_OFF: m_CommunityOption.iMessanger = 0;
          break;
        default: break;
      }
    }
