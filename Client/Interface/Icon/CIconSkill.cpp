...
void CIconSkill::GetToolTip(CInfo& ToolTip, DWORD dwDialogType, DWORD dwType) {
  ...
  switch ( dwDialogType ) {
    case DLG_TYPE_QUICKBAR: dwType = INFO_STATUS_FEW;
      break;
    default: if ( GetAsyncKeyState( VK_RBUTTON ) < 0 )
...
void          CIconSkill::AddSkillPower(int iSkillNo, CInfo& ToolTip) {
  ...
  switch ( SKILL_DAMAGE_TYPE( iSkillNo ) ) {
    case 0: strMsg.append( STR_SKILLPOWER_EFFECT_0 );
      break;
    case 1: strMsg.append( STR_SKILLPOWER_EFFECT_1 );
      break;
    case 2: strMsg.append( STR_SKILLPOWER_EFFECT_2 );
      break;
    case 3: strMsg.append( STR_SKILLPOWER_EFFECT_3 );
      break;
    default: break;
  }
...
bool CIconSkill::GetSkillIncreaseAbility(int iSkillNo, int iColumn, std::string& strOut, bool bAddTypeName) {
  ...
  if ( SKILL_INCREASE_ABILITY_VALUE( iSkillNo, iColumn ) ) {
    ...
    switch ( SKILL_TYPE( iSkillNo) ) {
      ...
      case 9:
      case 10:
      case 11: iIncreaseAbilityValue = SKILL_INCREASE_ABILITY_VALUE( iSkillNo, iColumn ) * (g_pAVATAR->Get_INT() + 300) / 315;
        break;
      default: iIncreaseAbilityValue = SKILL_INCREASE_ABILITY_VALUE( iSkillNo, iColumn );
        break;
    }
