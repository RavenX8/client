...
void CIconItem::GetToolTip(CInfo& strToolTip, DWORD dwDialogType, DWORD dwType) {
  ...
  switch ( dwDialogType ) {
    ...
    case DLG_TYPE_DEAL: dwInfoType |= INFO_STATUS_DETAIL;
      break;
    case DLG_TYPE_STORE: dwInfoType |= INFO_ADD_PRICE_SELL;
      dwInfoType |= INFO_STATUS_DETAIL;
      break;
    case DLG_TYPE_ITEM: if ( CGame::GetInstance().GetRepairMode() == CGame::REPAIR_NPC )
      ...
      break;
    case DLG_TYPE_AVATARSTORE: dwInfoType |= INFO_STATUS_DETAIL;
      break;
    case DLG_TYPE_PRIVATESTORE: dwInfoType |= INFO_ADD_PRICE_PRIVATESTORE;
      dwInfoType |= INFO_STATUS_DETAIL;
      break;
    default: break;
  }
