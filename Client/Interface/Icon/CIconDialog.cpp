...
CIconDialog* CIconDialog::CreateIcon(int iDialogType, bool bCreateDragItem) {
  ...
  Info.Clear();
  switch ( iDialogType ) {
    case DLG_TYPE_CLAN: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_GUILD" );
      Info.AddString( STR_CLAN );
      break;
    case DLG_TYPE_ITEM: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_ITEM" );
      Info.AddString( STR_ITEM );
      break;
    case DLG_TYPE_CHAR: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DLG_AVATAR" );
      Info.AddString( STR_AVATARINFO );
      break;
    case DLG_TYPE_SKILL: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_SKILL" );
      Info.AddString( STR_SKILL );
      break;
    case DLG_TYPE_QUEST: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_QUEST" );
      Info.AddString( STR_QUEST );
      break;
    case DLG_TYPE_COMMUNITY: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_COMMUNITY" );
      Info.AddString( STR_COMMUNITY );
      break;
      //	case DLG_TYPE_GUILD:
      //		iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_GUILD" );
      //		break;
    case DLG_TYPE_HELP: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_HELP" );
      Info.AddString( STR_HELP );
      break;
    case DLG_TYPE_OPTION: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_OPTION" );
      Info.AddString( STR_OPTION );
      break;
    case DLG_TYPE_PARTY: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( IMAGE_RES_UI, "UI21_ICON_DIALOG_PARTY" );
