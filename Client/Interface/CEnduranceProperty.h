...
public:
  ...
  virtual bool CreateEffect(CObjCHAR* pObjCHAR, int iEffectIDX) = 0 { *(int*)nullptr = 10; };
  virtual void DeleteEffect() = 0 { *(int*)nullptr                                   = 10; };

  virtual int GetIconNO() = 0 { *(int*)nullptr = 10; };

  /// if return value is false, this endurance entity is expired.
  virtual bool Proc(CObjCHAR* pObjCHAR) = 0 { *(int*)nullptr = 10; };
};
...
public:
  ...
  bool CreateEnduranceEntity(CObjCHAR* pObjCHAR, int iSkillIdx, int iStateNO, int iEnduranceTime) override;
  bool CreateEffect(CObjCHAR*          pObjCHAR, int iEffectIDX) override;
  void DeleteEffect() override;

  int          GetIconNO() override;
  virtual void ClearEffectResource();

  bool Proc(CObjCHAR* pObjCHAR) override;
};
...
public:
  ...
  bool CreateEnduranceEntity(CObjCHAR* pObjCHAR, int iUseItemIdx, int iStateNO, int iEnduranceTime) override;
  bool CreateEffect(CObjCHAR*          pObjCHAR, int iEffectIDX) override;
  void DeleteEffect() override;
