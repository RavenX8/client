...
private :
  ...
  void  GetHeightsByCoordinates(float fWorldX, float fWorldY, float fHeights[4], float* pfWeightHoriz = nullptr, float* pfWeightVert = nullptr);
...
public :
  ...
  float GetHeight(float fWorldX, float fWorldY, bool* pNotFound = nullptr);
  ...
  float GetHeightTop(float fWorldX, float fWorldY, bool* pNotFound = nullptr);
