...
MiniDumper::DumpLevel MiniDumper::s_DumpLevel            = DUMP_LEVEL_0;
...
LONG      WINAPI MiniDumper::TopLevelFilter(struct _EXCEPTION_POINTERS* pExPtr) {
  ...
  if ( hDLL == nullptr ) hDLL = ::LoadLibrary( _T("DBGHELP.DLL") );
  if ( hDLL == nullptr ) {
    return retval;
  }
  ...
  HANDLE hFile = ::CreateFile(
    szDumpPath, GENERIC_WRITE, FILE_SHARE_WRITE, nullptr,
  ...
  switch ( s_DumpLevel ) {
    case DUMP_LEVEL_0: // MiniDumpNormal
      bResult = pfnMiniDumpWriteDump(
        ...
        hFile, MiniDumpNormal, &ExceptionParam, nullptr, nullptr );
      break;
    case DUMP_LEVEL_1: // MiniDumpWithDataSegs 
      bResult = pfnMiniDumpWriteDump(
        GetCurrentProcess(), GetCurrentProcessId(),
        hFile, MiniDumpWithDataSegs, &ExceptionParam, nullptr, nullptr );
      break;
    case DUMP_LEVEL_2: // MiniDumpWithFullMemory 
      bResult = pfnMiniDumpWriteDump(
        GetCurrentProcess(), GetCurrentProcessId(),
        hFile, MiniDumpWithFullMemory, &ExceptionParam, nullptr, nullptr );
      break;
    default: bResult = pfnMiniDumpWriteDump(
               GetCurrentProcess(), GetCurrentProcessId(),
               hFile, MiniDumpNormal, &ExceptionParam, nullptr, nullptr );
      break;
  }
