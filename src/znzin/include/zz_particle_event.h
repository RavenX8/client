...
public:
  int type;
          ...
          zz_particle_event() : type( EVENT_NONE ) { m_NextFadeEvent = nullptr; }
...
public:
  ...
  bool FadeAllowed() override { return (true); }
  void DoItToIt(zz_particle& part) override;
  ...
  //----------------------------------------------------------------------------
  // Save, Load method..
  bool Load(zz_vfs* fs) override;
  bool Save(zz_vfs* fs) override;
...
public:
  ...
  bool FadeAllowed() override { return (false); }
  void DoItToIt(zz_particle& part) override;
