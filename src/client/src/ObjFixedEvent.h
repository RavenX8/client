...
public:
  ...
  /*override*/
  int Get_TYPE() override { return OBJ_EVENTOBJECT; }
  ...
  /*override*/
  void RemoveFromScene(bool bIncludeEFFECT) override;

  /*override*/
  void SetPOSITION(D3DVECTOR& Position) override;
  /*override*/
  bool Create(CMODEL<CFixedPART>* pMODEL, D3DVECTOR& Position, bool bCreateEffect = false) override;
  /*override*/
