...
bool CStoreDLG::On_LButtonUP(unsigned iProcID, WPARAM wParam, LPARAM lParam) {
  switch ( iProcID ) {
    case IID_BTN_CLOSE: g_itMGR.Close_store();
      break;
    case IID_BTN_TAB1: m_nInvType = 0;
      UpdateSlotPosition( m_nInvType );
      break;
    case IID_BTN_TAB2: m_nInvType = 1;
      UpdateSlotPosition( m_nInvType );
      break;
    case IID_BTN_TAB3: m_nInvType = 2;
      UpdateSlotPosition( m_nInvType );
      break;
    case IID_BTN_TAB4: m_nInvType = 3;
      UpdateSlotPosition( m_nInvType );
    default: break;
  }
  return false;
...
void CStoreDLG::SetEnableTabButton(int iInvType, bool bEnable) {
  ...
  unsigned int iID = 0;
  switch ( iInvType ) {
    case 0: iID = IID_BTN_TAB1;
      break;
    case 1: iID = IID_BTN_TAB2;
      break;
    case 2: iID = IID_BTN_TAB3;
      break;
    case 3: iID = IID_BTN_TAB4;
      break;
    default: return;
  }
