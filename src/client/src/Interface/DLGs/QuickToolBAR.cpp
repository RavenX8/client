...
unsigned int CQuickBAR::Process(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
  switch ( uiMsg ) {
    case WM_SYSKEYDOWN: switch ( wParam ) {
        case '1': m_nCurrentPage = 0;
          UpdateHotIconSlot();
          return uiMsg;
          break;
        case '2':
        case VK_F10: m_nCurrentPage = 1;
          UpdateHotIconSlot();
          return uiMsg;
        case '3': m_nCurrentPage = 2;
          UpdateHotIconSlot();
          return uiMsg;
        case '4': m_nCurrentPage = 3;
          UpdateHotIconSlot();
          return uiMsg;
    ...
    case WM_KEYUP: {
      switch ( wParam ) {
        ...
        case '3':
        case '4': {
          if ( CCountry::GetSingleton().IsApplyNewVersion() && CTControlMgr::GetInstance()->GetKeyboardInputType() == CTControlMgr::INPUTTYPE_NORMAL && nullptr == CTEditBox::s_pFocusEdit ) {
            m_nCurrentPage = wParam - '1';
            UpdateHotIconSlot();
            return uiMsg;
          }
        ...
        case VK_F9: m_nCurrentPage = 0;
          UpdateHotIconSlot();
          return uiMsg;
        case VK_F11: m_nCurrentPage = 2;
          UpdateHotIconSlot();
          return uiMsg;
        case VK_F12: m_nCurrentPage = 3;
          UpdateHotIconSlot();
          return uiMsg;
...
void        CQuickBAR::UpdateHotIconSlot() {
  ...
  if ( pCtrl ) {
    ...
    switch ( m_nCurrentPage ) {
      case 0: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( iModuleID, "UI21_NUMBER_1" );
        break;
      case 1: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( iModuleID, "UI21_NUMBER_2" );
        break;
      case 2: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( iModuleID, "UI21_NUMBER_3" );
        break;
      case 3: iGraphicID = CResourceMgr::GetInstance()->GetImageNID( iModuleID, "UI21_NUMBER_4" );
        break;
      default: break;
    }
