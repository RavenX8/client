...
bool CRestartDLG::On_LButtonUP(unsigned iProcID) {
  switch ( iProcID ) {
    ...
    case BTN_RESTART_DUNGEON_GATE: g_pNet->Send_cli_REVIVE_REQ( REVIVE_TYPE_SAVE_POS );
      Hide();
      break;
    case BTN_RESTART_CURRENT_FIELD: g_pNet->Send_cli_REVIVE_REQ( REVIVE_TYPE_REVIVE_POS );
      Hide();
      break;
  }
