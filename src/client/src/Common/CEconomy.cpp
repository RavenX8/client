...
int   CEconomy::Get_ItemBuyPRICE(short nItemTYPE, short nItemNO, short nBuySkillVALUE) {
  ...
  switch ( nItemTYPE ) {
    ...
    case ITEM_TYPE_USE:
    case ITEM_TYPE_NATURAL: if ( IsEssentialGoods( ITEM_TYPE( nItemTYPE, nItemNO ) ) ) {
        // 생필품.
...
int   CEconomy::Get_ItemSellPRICE(tagITEM& sITEM, short nSellSkillVALUE) {
  ...
  switch ( sITEM.m_cType ) {
    ...
    case ITEM_TYPE_USE:
    case ITEM_TYPE_NATURAL: if ( IsEssentialGoods( ITEM_TYPE( sITEM.m_cType, sITEM.m_nItemNo ) ) ) {
