...
#define	ITEM_RARE_TYPE(T,I)				g_pTblSTBs[T]->m_ppDATA[ I ][ 30 ] // Set To 3 for Rare Item Glow
...
//	@Use ITEM_xxxx
#define	WEAPON_GEM_COUNT(I)				g_TblWEAPON.m_ppDATA[ I ][ 30 ]
...
//	@Use ITEM_xxxx
#define SUBWPN_GEM_COUNT(I)				g_TblSUBWPN.m_ppDATA[ I ][ 30 ]
...
#define USEITEM_TYPE(I)						g_TblUSEITEM.m_ppDATA[ I ][  4 ]
...
/// NPC일경우( NPC_TYPE==999 )일경우에는 대화시 얼굴 이미지 인덱스이고 소환몹일경우에는 HP 계산식구분에 사용된다.
/// 2005/8/26 최종진
