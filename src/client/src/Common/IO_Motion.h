...
private :
  ...
  bool Load_FILE(tagFileDATA<tagMOTION*>* pData) override;
  void Free_FILE(tagFileDATA<tagMOTION*>* pData) override;
...
public :
  ...
  bool Load(char* szSTBFile, short nFileNameColNO = 0, char* szBaseDIR = nullptr);
  void Free() override;
