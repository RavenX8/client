...
/// ** ���� !!!
/// ��� ���� Ŭ�������� �ı��ڿ��� �Ʒ��� �Լ�
/// CFileLIST< dType >::Free () �� ȣ���ؾ� �޸𸮰� Ǯ����.
/// ~CFileLIST() ���� this->Free()�� ��� ��� ���� Ŭ������ Sub_DATA( ... ) �Լ���
/// �̹� �Ҹ�Ǿ� ���� �Լ� ȣ��� ���� �߻���.
///
#ifdef	_DEBUG
...
protected:
  ...
  virtual bool Load_FILE(tagFileDATA<dType>* pData) = 0 { *(int*)nullptr = 10; };
  virtual void Free_FILE(tagFileDATA<dType>* pData) = 0 { *(int*)nullptr = 10; };
