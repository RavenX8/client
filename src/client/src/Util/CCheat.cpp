...
int     classPARSESTR::DoSpecialCheat(char* pCheatCode, bool bServerCheate) {
  ...
  if ( bServerCheate ) {
    switch ( nCodeIdx ) {
      case CHEAT_SPECIAL_PVP: if ( DoSpecial( pCheatCode ) )
...
int     classPARSESTR::DoCheat(char* pCheatCode, bool bServerCheate) {
  ...
  if ( bServerCheate ) {
    switch ( nCodeIdx ) {
      case CHEAT_SET: if ( DoSET( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_ADD: if ( DoADD( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_FULL: if ( DoFULL( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_SKILL: if ( DoSKILL( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_ITEM: if ( DoITEM( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_MONEY: if ( DoMONEY( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_SER: if ( DoSER( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_FAME: if ( DoFAME( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_MEET: if ( DoMEET( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_FLY_MODE: if ( DoFLY_MODE( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_WARP: if ( DoWARP( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_WARP_M: if ( DoWARP_M( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
      case CHEAT_SOUND: if ( DoSOUND( pCheatCode ) )
          return CHEAT_RESULT_SERVER;
        break;
    ...
    switch ( nCodeIdx ) {
      case CHEAT_FEE: DoFee();
        return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_CLAN: if ( DoClan( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_PROC_VAL: if ( DoProcVal( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_UNION_FAME: if ( DoUnionFame( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_QUEST_VAL: if ( DoQuestVal( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_JOB: if ( DoJob( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
      case CHEAT_EFFECT: if ( DoEFFECT( pCheatCode ) )
          return CHEAT_RESULT_CLIENT;
        break;
...
void    classPARSESTR::DoFee() {
  ...
  switch ( paytype ) {
    case BILLING_MSG_FREE_USER: g_itMGR.AppendChatMsg( "무료 사용자입니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_FU: g_itMGR.AppendChatMsg( "평생무료 사용자입니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_FA: g_itMGR.AppendChatMsg( "개인정액 사용자입니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_FAP: g_itMGR.AppendChatMsg( "개인정액(플레티넘) 사용자입니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_FQ: g_itMGR.AppendChatMsg( "개인정량 사용자입니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_GU: g_itMGR.AppendChatMsg( "게임방 사용자로 접속되었습니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_GQ: g_itMGR.AppendChatMsg( "게임방의 과금기간(시간)이 만료되어 개인정량으로 접속되었습니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    case BILLING_MSG_PAY_IQ: g_itMGR.AppendChatMsg( "게임방의 접속 가능 IP숫자를 넘어 개인정량으로 접속되었습니다", IT_MGR::CHAT_TYPE_SYSTEM );
      break;
    default: break;
  }
