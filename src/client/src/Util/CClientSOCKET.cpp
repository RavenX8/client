/*
  $Header: /7HeartsOnline/LIB_Util/CClientSOCKET.cpp 4     04-10-22 11:14a
  Icarus $
*/
#include "StdAfx.h"
...
void CClientSOCKET::OnSend(int nErrorCode) {
  if ( !nErrorCode ) {
    m_bWritable = true;
    SetEvent( m_hThreadEvent ); // �����忡 �뺸 !!!
  }
}

//-------------------------------------------------------------------------------------------------
/*
void CClientSOCKET::Packet_Register2Q (classDLLIST <t_SendPACKET *> &PacketQ,
t_SendPACKET *pRegPacket)
{
...
void CClientSOCKET::Packet_Register2SendQ(const t_PACKET* const pRegPacket) {
  ...
  //	if ( m_cStatus == CLIENTSOCKET_CONNECTED )
  {
    ...
    // Encoding pSendPacket->m_Packet ... ���� �ִ����� ������... ���ڵ���
    // ������ ������ ������ ��Ƽ�����忡 ���� Ʋ������ �ֱ⶧����...
...
void CClientSOCKET::Packet_RecvFrom(void) {
  ...
  & ip code #define s_host  S_un.S_un_b.s_b2		// host on imp #define
  s_net   S_un.S_un_b.s_b1		// network #define s_imp
