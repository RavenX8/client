...
CClientStorage::CClientStorage(void) {
  ...
  ZeroMemory( &m_PlayOption, sizeof(t_OptionPlay));
  ZeroMemory( &m_CommunityOption, sizeof(t_OptionCommunity));
  ZeroMemory( &m_DialogPos, sizeof(t_DialogPos));
  ZeroMemory( &m_KeyboardOption, sizeof(t_OptionKeyboard));
  ...
  m_iChatDlgType            = 0; //CChatDLG::LIST_TYPE_SMALL;
  m_iJapanRoute             = 0;
...
void   CClientStorage::Save() {
  ...
  m_DialogPos[DLG_TYPE_MAX].nPosX = -999; ///������ ��� Dialog���� ��ġ�� ����Ǿ� �ִ°��� �Ǵ��ϱ� ���� ��
