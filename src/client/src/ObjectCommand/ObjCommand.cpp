...
CObjCommand* CObjCommandManager::GetObjCommand(int iCommandType) {
  switch ( iCommandType ) {
    case OBJECT_COMMAND_STOP: return new CObjStopCommand();
    case OBJECT_COMMAND_ATTACK: return new CObjAttackCommand();
    case OBJECT_COMMAND_SIT: return new CObjSitCommand();
    case OBJECT_COMMAND_STAND: return new CObjStandCommand();
    case OBJECT_COMMAND_MOVE: return new CObjMoveCommand();
    case OBJECT_COMMAND_DIE: return new CObjDieCommand();
    case OBJECT_COMMAND_TOGGLE: return new CObjToggleCommand();
    case OBJECT_COMMAND_Skill2SELF: return new CObjSkill2SelfCommand();
    case OBJECT_COMMAND_Skill2OBJ: return new CObjSkill2ObjCommand();
    case OBJECT_COMMAND_Skill2POS: return new CObjSkill2PosCommand();
  }
...
CObjCommand*   CObjCommandManager::GetLastInvalidSkillCommand() {
  CObjCommand* pObjCommand    = nullptr;
...
CObjCommand* CObjCommandManager::PopCommand(bool& bSkillCommand) {
  ...
  /// 마지막 명령을 저장해둔후에..
  /// 왜????
  CObjCommand* pObjCommand = nullptr; /// = m_ObjCommandList.back();
