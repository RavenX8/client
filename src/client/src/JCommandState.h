...
public:
  ...
  virtual bool ClickObject(int   iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 { *(int*)nullptr = 10; };
  virtual bool RButtonDown(int   iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 { *(int*)nullptr = 10; };
  virtual bool DBClickObject(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 { *(int*)nullptr = 10; };
  ...
  /// @brief ���� Ű���� �Է� ���¿� ���� Ÿ�� ����
  //----------------------------------------------------------------------------------------------------
  virtual void ClearMouseState() = 0 { *(int*)nullptr                                                                                                        = 10; };
  virtual void SetTargetObject(int            iTargetType, int iTargetObj, D3DVECTOR& pickPos, DWORD wVKeyState, bool bDBClick = false) = 0 { *(int*)nullptr = 10; };
  virtual void SetTargetObject_Normal(int     iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool  bDBClick                  = false) = 0 { *(int*)nullptr = 10; };
  virtual void SetTargetObject_CtrlClick(int  iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool  bDBClick                  = false) = 0 { *(int*)nullptr = 10; };
  virtual void SetTargetObject_ShiftClick(int iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool  bDBClick                  = false) = 0 { *(int*)nullptr = 10; };
...
public:
  ...
  /*override*/
  bool ClickObject(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) override;
  /*override*/
  bool RButtonDown(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) override;
  /*override*/
  bool DBClickObject(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) override;
  ...
  //----------------------------------------------------------------------------------------------------
  /*override*/
  void ClearMouseState() override;
  /*override*/
  void SetTargetObject(int iTargetType, int iTargetObj, D3DVECTOR& pickPos, DWORD wVKeyState, bool bDBClick = false) override;
  /*override*/
  void SetTargetObject_Normal(int iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool bDBClick = false) override;
  /*override*/
  void SetTargetObject_CtrlClick(int iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool bDBClick = false) override;
  /*override*/
  void SetTargetObject_ShiftClick(int iTargetType, int iTargetObj, D3DVECTOR& pickPos, bool bDBClick = false) override;
};
...
public:
  ...
  CUserInputSystem(const CUserInputSystem&) = delete;
  CUserInputSystem& operator=(const CUserInputSystem &) = delete;
  CUserInputSystem(CUserInputSystem &&) = delete;
  CUserInputSystem & operator=(CUserInputSystem &&) = delete;

  static auto& GetSingleton(){
    static CUserInputSystem inst;
    return inst;
  }
  ...
  void SetTargetObject(int            iTargetType, int iTargetObj, D3DVECTOR& pickPos, DWORD wVKeyState) { m_pUserInput->SetTargetObject( iTargetType, iTargetObj, pickPos, wVKeyState ); }
  void SetTargetObject_Normal(int     iTargetType, int iTargetObj, D3DVECTOR& pickPos) { m_pUserInput->SetTargetObject_Normal( iTargetType, iTargetObj, pickPos ); }
  void SetTargetObject_CtrlClick(int  iTargetType, int iTargetObj, D3DVECTOR& pickPos) { m_pUserInput->SetTargetObject_CtrlClick( iTargetType, iTargetObj, pickPos ); }
  void SetTargetObject_ShiftClick(int iTargetType, int iTargetObj, D3DVECTOR& pickPos) { m_pUserInput->SetTargetObject_ShiftClick( iTargetType, iTargetObj, pickPos ); }
