...
public:
  ...
  /*override*/
  int Get_HP() override { return GetCur_HP(); } // 생명력

  /*override*/
  int Get_LEVEL() override { return GetCur_LEVEL(); }
  /*override*/
  int Get_ATK() override { return GetCur_ATK(); } // 공격력
  /*override*/
  int Get_DEF() override { return GetCur_DEF(); } // 방어력
  /*override*/
  int Get_RES() override { return GetCur_RES(); } // 항마력
  /*override*/
  int Get_HIT() override { return GetCur_HIT(); }
  /*override*/
  int Get_CHARM() override { return GetCur_CHARM(); } // 매력
  /*override*/
  int Get_AVOID() override { return GetCur_AVOID(); } // 회피력
  /*override*/
  int Get_SENSE() override { return GetCur_SENSE(); } // 감각
  /*override*/
  ...
  /*override*/
  int Get_CON() override { return GetCur_CON(); } // 집중
  ...
  /*override*/
  int Get_INT() override { return GetCur_INT(); } // 지력
...
public:
  ...
  int64_t Get_EXP() { return GetCur_EXP(); }
  ...
  int64_t Get_MONEY() { return GetCur_MONEY(); } // 돈
  ...
  //-------------------------------------------------------------------------------------------------
  void UpdateAbility();
  void UpdateModelData() override { Update(); }; /// 모델 데이터 갱신..
