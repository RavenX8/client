...
enum t_EquipINDEX {
	...
	EQUIP_IDX_NECKLACE,
	EQUIP_IDX_RING,
	EQUIP_IDX_EARRING,	// 2003. 10. 27 : �������� ������ 2��...
...
enum t_eItemCLASS {
	...
	JEWEL_ITEM_EARRING		= 173,		// �Ͱ���

	WEAPON_ITEM_USE_ARROW		= 231,		// SHOT_TYPE_ARROW �Ҹ��ϴ� ����
	WEAPON_ITEM_USE_ARROW2		= 271,		// SHOT_TYPE_ARROW �Ҹ��ϴ� ����(�Ѽտ��Ÿ�����)
	WEAPON_ITEM_USE_BULLET		= 232,		// SHOT_TYPE_BULLET �Ҹ��ϴ� ����
	WEAPON_ITEM_USE_THROW		= 233,		// SHOT_TYPE_THROW �Ҹ��ϴ� ����
	WEAPON_ITEM_USE_BULLET2		= 253,		// SHOT_TYPE_BULLET �Ҹ��ϴ� ����
	WEAPON_ITEM_NOT_USE_BULLET	= 242,	// SHOT_TYPE_BULLET �Ҹ��ϴ� ����


	WEAPON_ITEM_SHIELD			= 261,		// ���� ������


	USE_ITEM_SKILL_DOING		= 313,		// �Ҹ��� ���������� ��ų ����
	USE_ITEM_SKILL_LEARN		= 314,		// �Ҹ��� ���������� ��ų ����

	USE_ITEM_REPAIR_ITEM		= 315,		// �Ҹ��� ���������� ���� ����
	USE_ITEM_EVENT_ITEM			= 316,		// ���� �̺�Ʈ ��ũ��..
	USE_ITEM_FUEL				= 317,		// ���� ������
	USE_ITEM_VOLATILITY_ITEM	= 320,		// ������ �ٷ� �Ҹ��Ǵ� ������

	USE_ITEM_MAINTAIN_ITEM		= 321,		// ���� �ð����� �����Ǵ� ������(â�����Ἥ����,â��Ȯ��...)

	TUNING_PART_BODY_CART			= 511,	// Ʃ�׺�ǰ - īƮ �ٵ�
	TUNING_PART_BODY_CASTLEGEAR		= 512,	// Ʃ�׺�ǰ - �ɽ����� �ٵ�
	TUNING_PART_ENGINE_CART			= 521,	// Ʃ�׺�ǰ - īƮ ����
	TUNING_PART_ENGINE_CASTLEGEAR	= 522,	// Ʃ�ú�ǰ - ĳ������ ����
...
/// �������� �ߺз� ���� --> STB ���� !!.
enum t_eITEM {
	ITEM_TYPE_FACE_ITEM = 1,		// 1	LIST_FACEITEM.stb	���� ����	
	...
	ITEM_TYPE_JEWEL,				// 7	LIST_JEWEL.stb		���ű� : ������ ����

	ITEM_TYPE_WEAPON,				// 8	LIST_WEAPON.stb		����
	ITEM_TYPE_SUBWPN,				// 9	LIST_SUBWPN.stb

	ITEM_TYPE_USE,					// 10	LIST_USEITEM.stb	�Ҹ�

	ITEM_TYPE_ETC,					// 11
	ITEM_TYPE_GEM = ITEM_TYPE_ETC,	// 11	LIST_JEMITEM.stb	��Ÿ : ����
...
enum t_AbilityINDEX {
	...
	AT_PSV_ATK_POW_1HAND_WPN	= 42,	// ���ݷ� : �Ѽ�	<< AT_PSV_ATK_POW_SWORD �� ���� �Ѽ����� ���� 2004. 2. 26 by icarus
	AT_PSV_ATK_POW_2HAND_WPN	= 43,	//			����	<< AT_PSV_ATK_POW_AXE	�б⿡�� ������ ����
	AT_PSV_ATK_POW_BOW			= 44,
	AT_PSV_ATK_POW_GUN			= 45,
	AT_PSV_ATK_POW_STAFF_WAND	= 46,
	AT_PSV_ATK_POW_AUTO_BOW		= 47,	// ����
	AT_PSV_ATK_POW_KATAR_PAIR	= 48,	// �̵���

	AT_PSV_ATK_SPD_BOW			= 49,
	AT_PSV_ATK_SPD_GUN			= 50,
	AT_PSV_ATK_SPD_PAIR			= 51,	// �̵���
	...
	AT_PSV_SAVE_MP				= 61,	// MP ����

	AT_PSV_SUMMON_MOB_CNT		= 62,	// ��ȯ���� ����
	AT_PSV_DROP_RATE			= 63,	// ���� Ȯ��

	AT_AFTER_PASSIVE_SKILL		= 71,						// �нú� ��ų �����ɷ�ġ ����...
	AT_RACE						= AT_AFTER_PASSIVE_SKILL,	// ���� init_avatar.stb ���ι�ȣ / 2
	...
	AT_BANK_FREE				= AT_MAINTAIN_ABILITY,	// â�� ���� 
	AT_BANK_ADDON				= 95,					// â�� Ȯ��
	AT_STORE_SKIN				= 96,					// â�� ����
	AT_PATHP					= 97,
...
enum t_BasicAbilityINDEX {
	BA_STR=0,	// 			short	m_nSTR;			// �ٷ� 1~200
	BA_DEX,		// short	m_nDEX;			// ��ø 1~200
	BA_INT,		// short	m_nINT;			// ���� 1~200
	BA_CON,		// short	m_nCON;			// concentration ���߷� 1~200
	BA_CHARM,	// short	m_nCHARM;		// �ŷ� 1~200
...
enum eING_TYPE {
	...
	ING_PROC = 1,
	ING_INC_HP = ING_PROC,				// ó�� : hp ��ȭ
	ING_INC_MP,							// ó�� : mp ��ȭ
	ING_POISONED,						// ó�� : �ߵ�

	ING_INC_MAX_HP=4,					// ���� : �ִ� hp
	ING_INC_MAX_MP,						// ���� : �ִ� mp

	ING_CHECK_START = 6,

	ING_INC_MOV_SPD=ING_CHECK_START,	// ���� : �̼�/����
	ING_DEC_MOV_SPD,					// ���� : �̼�/����
	ING_INC_ATK_SPD=8,
	ING_DEC_ATK_SPD,
	ING_INC_APOWER=10,					// ���� : ���ݷ�
	...
	ING_INC_HIT=16,						// ���� : ����
	ING_DEC_HIT,
	ING_INC_CRITICAL=18,				// ���� : ũ��Ƽ��
	ING_DEC_CRITICAL,
	ING_INC_AVOID=20,					// ���� : ȸ�Ƿ� 
	ING_DEC_AVOID,
	ING_DUMB=22,						// ���� : ��� : skill stb 5�� �÷��� 7~14�� ��ų ���� ����.
	ING_SLEEP,							// ���� : ���� : ���� �Ҵ� ���·�.. ���� ������ Ǯ��
	ING_FAINTING,						// ���� : ���� : ������ ������ ���� �޾Ƶ� ��Ǯ��
	ING_DISGUISE,						// ���� : ���� : 
	ING_TRANSPARENT,					// ���� : ���� :
	ING_SHIELD_DAMAGE=27,				// ���� : ���� ������
	ING_DUMMY_DAMAGE=28,				// ���� : �߰� ������

	ING_CHECK_END = ING_DUMMY_DAMAGE,

	ING_DEC_LIFE_TIME=29,				// ó�� : ��ȯ�� �ɸ��� ���� �ð�...	�߰�: 2004. 4. 6 

	ING_CLEAR_GOOD,						// �ﰢ : ���� ���� ����
	ING_CLEAR_BAD,						// �ﰢ : �Ҹ� ���� ����
	ING_CLEAR_ALL,						// �ﰢ : ���� ���� ����
	ING_CLEAR_INVISIBLE,				// �ﰢ : �������� ����(ING_DISGUISE,ING_TRANSPARENT) 
