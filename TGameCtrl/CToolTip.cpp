...
void CToolTip::SetImageTop(CTImage* pImage) {
  m_pImageTop = pImage;
  pImage->Show();
}

void CToolTip::SetImageMiddle(CTImage* pImage) {
  m_pImageMiddle = pImage;
  pImage->Show();
}

void CToolTip::SetImageBottom(CTImage* pImage) {
  m_pImageBottom = pImage;
  pImage->Show();
}
