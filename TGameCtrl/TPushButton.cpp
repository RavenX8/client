  ...
  switch ( uiMsg ) {
    case WM_LBUTTONDOWN: {
      ...
      switch ( m_iButtonState ) {
        case BS_CLICKED: m_iButtonState = BS_NORMAL;
          return m_iControlID;
        case BS_NORMAL: m_iButtonState = BS_CLICKED;
          return m_iControlID;
        default: break;
      }
...
void CTPushButton::Draw() {
  ...
  if ( m_pDraw ) {
    if ( !IsEnable() ) {
      ...
      switch ( m_iButtonState ) {
        case BS_CLICKED: m_pDraw->Draw( m_sPosition.x, m_sPosition.y, m_iModuleID, m_iDownGraphicID );
          break;
        case BS_MOUSEOVER: m_pDraw->Draw( m_sPosition.x, m_sPosition.y, m_iModuleID, m_iOverGraphicID );
          break;
        default: m_pDraw->Draw( m_sPosition.x, m_sPosition.y, m_iModuleID, m_iNormalGraphicID );
          break;
      }
    }
  }
