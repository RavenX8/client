...
CTScrollBar::CTScrollBar(void) {
  m_pPrevButton    = nullptr;
  m_pNextButton    = nullptr;
  m_pScrollBox     = nullptr;
  m_pScrollModel   = nullptr;
  m_pScrollBarType = nullptr;
}
...
bool CTScrollBar::Create(int iScrX, int iScrY, int iWidth, int iHeight, int iType) {
  switch ( iType ) {
    case CTScrollBarType::TSBT_VERTICAL: m_pScrollBarType = new CTScrollBarTypeVertical;
      break;
    case CTScrollBarType::TSBT_HORIZONTAL: m_pScrollBarType = new CTScrollBarTypeHorizontal;
      break;
    default: m_pScrollBarType = new CTScrollBarTypeVertical;
      break;
  }
...
RECT   CTScrollBar::GetThumbMoveRange() {
  RECT rc = { 0, 0, 0, 0 };
  if ( m_pScrollBox == nullptr || m_pScrollBarType == nullptr )
    return rc;
